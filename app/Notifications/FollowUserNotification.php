...
class FollowUserNotification extends Notification
{
    ...
    public function __construct(User $follower, User $user)
    {
        ...
        $this->subject = 'Follow Notification';
        $this->first_message = "This is to notify that you were just followed by <a class='text-blue-500 underline' target='_blank' href='".route('profile.show', $follower->slug)."'> {$follower->user_name}</a>";
