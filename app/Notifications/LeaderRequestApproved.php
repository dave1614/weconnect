...
class LeaderRequestApproved extends Notification
{
    use Queueable;
    ...
    public function __construct(User $admin_user, CommunityHeadRequest $leader_request, User $user)
    {
        ...
        $this->subject = 'Community leader request approval';
        $this->first_message = "This is to notify that your request to become {$position} for {$community} community made on {$leader_request->created_at->format('d M Y')} has been approved by admin. ";
