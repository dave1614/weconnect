...
class UnFollowUserNotification extends Notification
{
     ...
     */
    public function __construct(User $unfollower, User $user)
    {
        ...
        $this->subject = 'Unfollow Notification';
        $this->first_message = "This is to notify that you were just unfollowed by <a class='text-blue-500 underline' target='_blank' href='".route('profile.show', $unfollower->slug)."'> {$unfollower->user_name}</a>";
