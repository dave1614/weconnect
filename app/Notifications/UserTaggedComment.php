...
class UserTaggedComment extends Notification
{
     ...
     */
    public function __construct(User $tagger, User $user)
    {
        ...
        $this->first_message = "This is to notify that you were just tagged on a comment by user <a class='text-blue-500 underline' target='_blank' href='".route('profile.show', $tagger->slug)."'> {$tagger->user_name}</a>";
