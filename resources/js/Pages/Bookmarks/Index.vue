...
const fetchMorePosts = async () => {
  try {
    ...
    let queryRoute = route('bookmark.load_more_posts');
...
<template>
  ...
  <LayoutSocial :highlight_type="'bookmarks'">
        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12 sm:col-span-9 border-0  min-h-screen dark:text-slate-400">
            <div class="sm:px-7 px-2 py-4">
              <div class="mt-[50px]">
                <SectionTitleLineWithButton :icon="mdiBookmark" :title="`All your bookmarks`" main>
                  <!-- <BaseButton
