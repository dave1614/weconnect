...
const fetchMorePosts = async () => {
  try {
    ...
    let queryRoute = route('search.load_more_posts', props.search_param);
...
<template>
  <Head :title="`Search results for ${search_param}`" />
  <LayoutSocial>
        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12 sm:col-span-9 border-0  min-h-screen dark:text-slate-400">
            <div class="sm:px-7 px-2 py-4">
              <div class="mt-[50px]">
                <SectionTitleLineWithButton :icon="mdiPound" :title="`Search results for &quot;<em class='text-primary-100'>${search_param}</em>&quot;`" main>
                  <!-- <BaseButton
